...
> 举例：某市某家医院的中医大夫，经常给病人开中成药A。（暂不讨论药的成分、作用和效果。）大夫和医院能通过在处方中开具A而获得提成，从而增加收入。

这样的盈利模式，会导致医生／医院被利润所左右而不是疗效。其实这样的问题也同样存在于西医，医院通过检查、化验、理疗、手术来盈利，而不一定是疗效。这些都是行政制度问题，而不是中医学本身的问题。
